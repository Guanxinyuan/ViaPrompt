    ...
    return (
        <div className="bg-gray-100 min-h-screen">
            ...
            <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                <h1 className="text-3xl font-bold text-gray-800 mb-8">User Guide</h1>
                <section className="mb-12">
                    <h2 className="text-2xl font-bold text-gray-800 mb-4">Component 1</h2>
                ...
                <section className="mb-12">
                    <h2 className="text-2xl font-bold text-gray-800 mb-4">Component 2</h2>
                    <p className="text-gray-700 mb-2">
                ...
                <section className="mb-12">
                    <h2 className="text-2xl font-bold text-gray-800 mb-4">Component 3</h2>
                    <p className="text-gray-700 mb-2">
